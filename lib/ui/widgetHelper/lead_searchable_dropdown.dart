...
class LeadSearchableDropdown extends StatefulWidget {
  final TextEditingController searchBarController;
  final Function(String) onSearchTextChanged;
  final Function onSelected;
  final String searchBarTitle;
  final List<SearchLeadNew> selected;
  final List<SearchLeadNew> all;
  final bool searching;

  const LeadSearchableDropdown({
    required Key key,
  ...
  @override
  _LeadSearchableDropdownState createState() => _LeadSearchableDropdownState();
}

class _LeadSearchableDropdownState extends State<LeadSearchableDropdown> {
                ...
                itemBuilder: (context, int index) {
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          widget.all.elementAt(index).name ?? 'No Title',
  ...
  Widget _buildFieldTags() {
    return Row(
      children: [
        Expanded(
            child: Text(widget.selected[0].name ?? 'No Title',
                style: textHelper.defaultText,
