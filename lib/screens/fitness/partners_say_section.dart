...
class _PartnerSaySectionState extends State<PartnerSaySection> {
          ...
          SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return item(isMobile: isMobile(),isDesktop: isDesktop(),index:index );
                  }))
        ],
      ),
    );
  ...
  Widget item({required bool isMobile,required bool isDesktop,required int index}) {
    return Padding(
