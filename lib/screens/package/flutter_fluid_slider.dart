...
class _FluidSliderState extends State<FluidSlider>
  ...
  TextStyle _currentValTextStyle(BuildContext context) {
    final TextStyle defaultStyle = widget.showDecimalValue
        ? Theme.of(context).textTheme.subtitle2 != null
            ? Theme.of(context)
                .textTheme
                .subtitle2!
        ...
        : Theme.of(context).textTheme.subtitle2 != null
            ? Theme.of(context)
                ...
                .copyWith(fontWeight: FontWeight.bold)
            : TextStyle();
    return widget.valueTextStyle ?? TextStyle();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        // _sliderWidth = constraints.hasBoundedWidth ? constraints.maxWidth : 400;
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: child ??
            Text(
              '${value!.toInt()}',
              style: textStyle ?? Theme.of(context).accentTextTheme.subtitle2,
            ),
      ),
    );
  }
